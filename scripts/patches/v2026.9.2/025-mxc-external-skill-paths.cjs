...
const MARKER = 'JUSTDO_MXC_EXTERNAL_SKILL_RUNTIME_PATHS_V2026_9_2';
const ANCHOR =
...
const PATCHED_PATTERN =
  /const skillsPromptWorkspaceDir = params\.sandbox\.backendId === "mxc" && params\.sandbox\.skillsWorkspaceDir \? params\.sandbox\.skillsWorkspaceDir\.replace\(\/\\\\\/g, "\/"\) \/\*JUSTDO_MXC_EXTERNAL_SKILL_RUNTIME_PATHS_V2026_9_2\*\/ : params\.sandbox\.workspaceAccess === "rw" && params\.sandbox\.skillsWorkspaceDir && params\.sandbox\.containerWorkdir \? [^;\r\n]+ : params\.sandbox\.containerWorkdir \?\? skillsWorkspaceDir;/g;
