...
// Target: openclaw@2026.9.2 bundled OpenAI provider plugin entrypoint.
...
const MARKER = 'JUSTDO_ISOLATED_OPENAI_COMPATIBLE_MEDIA_PROVIDERS_V2026_9_2';
...
const HELPER = [
  ...
  '\t};',
  '}',
  'function buildJustDoImageGenerationProvider() {',
  ...
  '\t};',
  '}',
  'function buildJustDoVideoGenerationProvider() {',
...
const PATCHED_IMAGE_REGISTRATION =
  '\t\tapi.registerImageGenerationProvider(buildJustDoImageGenerationProvider());';
const PATCHED_VIDEO_REGISTRATION =
  '\t\tapi.registerVideoGenerationProvider(buildJustDoVideoGenerationProvider());';
