...
const DisplayPanelLauncher = ({
  ...
  <div className="flex h-full flex-col justify-center gap-1.5 bg-surface p-6">
    <button
      type="button"
      disabled={browserDisabled}
      onClick={onCreateBrowser}
      className="flex h-10 w-full items-center gap-2.5 rounded-lg bg-surface-raised px-3 text-left text-sm font-medium text-foreground transition-colors hover:bg-surface-overlay disabled:cursor-not-allowed disabled:opacity-40"
    >
