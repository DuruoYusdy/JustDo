...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    general: '通用',
    voiceSettings: '语音',
    voiceSettingsDescription: '语音识别和回复朗读均可选择本地离线或在线服务。',
    ...
    voiceAsrModelWhisperBase: 'Whisper Base INT8（兼容备选 · 83.4 MiB）',
    voiceAsrModelSenseVoice: 'SenseVoice Small INT8（推荐、中英日韩粤 · 148.2 MiB）',
  ...
  en: {
    ...
    voiceSettingsDescription:
      'Use local offline or online services for speech recognition and response reading.',
    ...
    voiceAsrModelWhisperBase: 'Whisper Base INT8 (compatibility fallback · 83.4 MiB)',
    voiceAsrModelSenseVoice: 'SenseVoice Small INT8 (recommended, CJK + English · 148.2 MiB)',
