...
export const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    general: '通用',
    voiceSettings: '语音',
    voiceSettingsDescription: '语音识别和朗读均在本机运行，不会将录音或文本发送到第三方语音服务。',
    ...
    voiceMeetingModeDescription: '持续录音并分段转写；麦克风和系统声音会保留来源标记。',
    ...
    voiceOutputDescription: '在助手回复下方显示朗读按钮，使用本地 Kokoro 模型生成语音。',
    ...
    voiceAsrModelWhisperTiny: 'Whisper Tiny INT8（轻量 · 52.7 MiB）',
    voiceAsrModelWhisperBase: 'Whisper Base INT8（均衡 · 83.4 MiB）',
    voiceAsrModelSenseVoice: 'SenseVoice Small INT8（中文会议 · 148.2 MiB）',
    ...
    voicePrivacyNote:
      '当前本地语音包仅支持 Windows x64；配置保存后立即应用，朗读引擎可能短暂重载。',
  ...
  en: {
    ...
    voiceSettingsDescription:
      'Speech recognition and reading run entirely on this device. Recordings and text are not sent to a third-party speech service.',
    ...
    voiceMeetingModeDescription:
      'Keep recording in segments and label microphone and system-audio transcripts separately.',
    ...
    voiceOutputDescription:
      'Show a read-aloud button below assistant responses and generate speech with the local Kokoro model.',
    ...
    voiceAsrModelWhisperTiny: 'Whisper Tiny INT8 (compact · 52.7 MiB)',
    voiceAsrModelWhisperBase: 'Whisper Base INT8 (balanced · 83.4 MiB)',
    voiceAsrModelSenseVoice: 'SenseVoice Small INT8 (Chinese meetings · 148.2 MiB)',
    ...
    voicePrivacyNote:
      'The local speech bundle currently supports Windows x64. Settings apply immediately; the reading engine may reload briefly.',
