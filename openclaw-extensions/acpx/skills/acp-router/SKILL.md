---
name: acp-router
description: Route plain-language requests for Claude Code, Cursor, Copilot, OpenClaw ACP, OpenCode, DeepSeek Harness, Hermes, Gemini CLI, Qwen, Kiro, Kimi, iFlow, Factory Droid, Kilocode, or explicit ACP harness work into either OpenClaw ACP runtime sessions or direct acpx-driven sessions ("telephone game" flow). For coding-agent thread requests, read this skill first, then use only `sessions_spawn` for thread creation. Codex chat binding defaults to the native Codex app-server plugin unless ACP is explicit or background spawn needs ACP.
user-invocable: false
---

# ACP Harness Router

When user intent is "run this in Claude Code/Cursor/Copilot/OpenClaw/OpenCode/DeepSeek Harness/Hermes/Gemini/Qwen/Kiro/Kimi/iFlow/Droid/Kilocode (ACP harness)", do not use subagent runtime or PTY scraping. Route through ACP-aware flows.
...
- run something in Claude Code / Cursor / Copilot / OpenClaw / OpenCode / DeepSeek Harness / Hermes / Gemini / Qwen / Kiro / Kimi / iFlow / Droid / Kilocode
...
- "deepseek harness" or "dsh" -> `agentId: "deepseek-harness"`
- "hermes" or "hermes agent" -> `agentId: "hermes"`
...
- `kimi -> kimi acp`
- `kiro -> kiro-cli acp`
- `opencode -> opencode acp` (registered by the product catalog)
- `deepseek-harness -> dsh --profile acp` (registered by the product catalog)
- `hermes -> hermes acp` (registered by the product catalog)
- `qwen -> qwen --acp`
